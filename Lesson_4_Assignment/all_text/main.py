...
def preprocess():
    ...
    """
    count = 0
    zhwiki_path = './zhwiki-20190720-pages-articles-multistream.xml.bz2'
    f = open('./reduce_zhwiki.txt', 'w', encoding='utf8')  # 每次成功跑完，最好改下名字，防止重新跑覆盖了
...
def train_w2v():
    ...
    :return: 数据保存到/zhwiki_news.word2vec
========================
...
def test_w2v():
    ...
    :return:
    """
    model = Word2Vec.load('./zhwiki_news.word2vec')
...
def train_d2v():
    ...
    model.save('./zhwiki_news.doc2vec')
